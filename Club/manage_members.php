...
?>
	...
	<div class="row">
		<div class="col-lg-12">
				<h1 class="page-header">Посещения</h1>
		</div>
	</div><!--/.row-->
	...
	if($role=="President")
	{
		echo '<div class="row">
				<div class="col-lg-12">
					<a style="color: #fff;" href="add_member.php"><h1 class="ribbon"><i class="fa fa-user-plus" aria-hidden="true"></i> <b>Добавить участника</b></strong>
					</h1></a>
				</div>
			</div>';
	}
