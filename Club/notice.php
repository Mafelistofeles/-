...
?>
	...
	<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Доска событий</h1>
			</div>
	</div><!--/.row-->
	...
	if($role=="President")
	{
		echo '<div class="row">
				<div class="col-lg-12">
					<a style="color: #35682d;" href="add_notice.php"><h1 class="ribbon"><i class="fa fa-plus-circle" aria-hidden="true"></i> <b>Добавить событие</b></strong>
					</h1></a>
				</div>
			</div>';
	}
