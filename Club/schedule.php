...
?>
	...
	<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Расписание мероприятий</h1>
			</div>
	</div><!--/.row-->
	...
	if($role=="President")
	{
		echo '<div class="row">
				<div class="col-lg-12">
					<a style="color: #fff;" href="add_event.php"><h1 class="ribbon"><i class="fa fa-calendar-plus-o" aria-hidden="true"></i> <b>Добавить запись о мероприятии</b></strong>
					</h1></a>
				</div>
			</div>';
	}
