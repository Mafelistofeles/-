...
?>
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Последние записи в блоге</h1>
		</div>
	</div>
	...
	<?php
		if(isset($_SESSION['username']))
		{
			echo '<div class="row">
					<div class="col-lg-12">
						<a style="color: #fff;" href="new-post.php"><h1 class="ribbon"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> <b>Новый пост</b></strong>
							</h1></a>
					</div></div>';
		}
	?>
