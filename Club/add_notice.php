...
?>
		...
		<div class="row">
			<ol class="breadcrumb">
				...
				<li><a href="notice.php">Событие</a></li>
				<li class="active">Добавить событие</li>
			</ol>
		</div><!--/.row-->

		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Добавить новое событие</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			...
			<div class="col-lg-offset-2 col-lg-6">
				<form class="form-signin" method="post" action="">
					<label for="name">Заголовок события</label>
					<input type="text" name="name" placeholder="макс. 150 char" id="name" class="form-control" require><br>
					<label for="name">Текст</label>
					<textarea name="description" placeholder="макс 250 char" id="email" class="form-control" require></textarea><br>
					<label for="name">Дата</label>
					<input type="datetime-local" id="date" name="date" class="form-control" required><br><br>
					<button class="btn btn-primary" name="add_notice" type="submit">Добавить</button>&nbsp;&nbsp;
					<a type="button" class="btn btn-default" href="notice.php" class="btn btn-default">Отменить</a>
				</form>
