	...
	?>
		...
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Удалить участника</li>
			</ol>
		</div><!--/.row-->

		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Удаление участника</h1>
			</div>
		</div><!--/.row-->
				...
				<div class="panel panel-danger">
					...
					<div class="panel-body">
						<form class="" method="post" action="">
							<label for="ask">Участник будет удалён!</label>
							<br>
					<div class="panel-footer">
						<div class="pull-right">
							<button class="btn btn-danger" name="yes" type="submit" id="login">Подтвердить удаление</button>&nbsp;&nbsp;
