...
?>
		...
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Запись посещений</li>
			</ol>
		</div><!--/.row-->

		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Заполнение заявки на участие в сессии</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			...
			<div class="col-lg-offset-2 col-lg-6">
				<div class="panel panel-primary">
					...
					Отметьте всех Присутствующих Участников
					</div>
					<div class="panel-body">
						...
						<div class="panel-footer">
							<button class="btn btn-primary pull-left" name="submit_attendance" type="submit" id="login">Сохранить посещения</button>&nbsp;&nbsp;
							<a href="attendance.php" class="btn btn-default" id="login">Отмена</a>
						</div>
						</div>
						</form>
					</div>
