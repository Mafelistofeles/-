...
// Формируем отформатированную строку
	...
	<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Удалить событие</li>
			</ol>
		</div><!--/.row-->

		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Удаление события</h1>
			</div>
		</div><!--/.row-->
				...
				<div class="panel panel-danger">
					...
					<div class="panel-body">
						<form class="" method="post" action="">
							<label for="ask">Событие будет удалено!</label>
							<br>
					<div class="panel-footer">
						<div class="pull-right">
							<button class="btn btn-danger" name="yes" type="submit" id="login">Удалить</button>&nbsp;&nbsp;
							<a href="notice.php" class="btn btn-default" id="login">Отменить</a>
						</div>
					</div>
						</form>
					</div>
